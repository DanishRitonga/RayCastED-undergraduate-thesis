\begin{tikzpicture}[
	...
	boundary/.style={thick, blue!70!black},
	boundaryfade/.style={thin, blue!30},
...
% Fill: top/right edges + smooth curve closing bottom-left
\fill[blue!8] (v0)--(v1)--(v2)--(v3)--(v4)
	.. controls (1.8,-0.6) and (-0.2,0.4) .. (v0);

% Outline: prominent on top/right, faded on bottom/left
\draw[boundary] (v1)--(v2)--(v3);
\draw[boundaryfade] (v3)--(v4) .. controls (1.8,-0.6) and (-0.2,0.4) .. (v0)--(v1);

% Vertex dots and labels (middle vertices only)
...
\node[draw, rounded corners=2pt, fill=white, inner sep=5pt, font=\scriptsize,
	...
	\begin{tabular}{@{}cl@{}}
		...
		\tikz\draw[boundary](0,0)--(0.5,0);                   & Polygon boundary \\
