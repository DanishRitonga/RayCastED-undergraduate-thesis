...
\begin{figure}[H]
	\centering
	\resizebox{0.95\textwidth}{!}{\input{contents/chapter-3/fig/data-preprocessing}}
...
\subsubsubsection{RayCast Permutations.}
...
\subsubsubsection{Augmentation Operations.}
