...
\paragraph{RayCast Representation Generation.}

\begin{figure}[H]
    \centering
    \resizebox{0.95\textwidth}{!}{\input{contents/chapter-2/fig/star-convex}}
    \caption{Star-convex polygon property. (Left) A star-convex polygon with centroid $\mathbf{c}$, polar grid, and 12 radial rays with angular spacing $\theta_i$. (Right) The same representation overlaid on a histopathology cell image.}
...
\paragraph{Data Ingestion Design.}
...
\paragraph{Data Profile Registration.}
...
\paragraph{Stain Vector Estimation and Normalization.}
...
\paragraph{Image Size Standardization.}
...
\paragraph{RayCast Permutations.}
...
\paragraph{Augmentation Operations.}
...
\subsubsection{Auxiliary Heads}

\subsubsection{Optimization Algorithm and Hyperparameters}
