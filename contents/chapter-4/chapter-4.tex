...
To assess the practicality of RayCastED for clinical deployment on resource-constrained hardware, the smallest variant is benchmarked on two platforms: a desktop GPU (RTX 5070 Ti) and an embedded AI accelerator (Jetson Orin Nano). Table~\ref{tab:edge} compares accuracy and throughput across five configurations.
